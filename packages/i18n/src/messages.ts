...
export const he: Record<MessageKey, string> = {
  ...
  'home.upcomingShiftsCount': '{count} משמרות קרובות',
  'home.openShiftsCount': '{count} עדיין דורשות נהג/ת',
  'home.myAssignmentsTitle': 'המשמרות הקרובות שלכם',
  'home.myAssignmentsEmpty': 'אין לכם משמרות קרובות.',
  'home.helpNeededTitle': 'משמרות שדורשות נהג/ת',
  'home.helpNeededEmpty': 'כל המשמרות הקרובות מכוסות.',
  'home.helpNeededMore': 'עוד {count} בלוח הזמנים המלא',
  'home.pendingSwapsTitle': 'החלפות ממתינות',
  ...
  'home.workspaceLoading': 'טוען את המשמרות שלכם…',
  'home.workspaceError': 'לא ניתן היה לטעון את המשמרות שלכם. נסו שוב.',
