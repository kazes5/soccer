 ...
 * target to already have a password set. Shelling out to that same script
 * (as a real operator would) is the only way to reach `/system` in a test,
 * and exercises the actual bootstrap procedure rather than a shortcut
 * around it.
 */
